<!DOCTYPE html>
<!-- saved from url=(0032)http://demo.laravelcommerce.com/ -->
<html><!-- meta contains meta taga, css and fontawesome icons etc --><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<meta name="csrf-token" content="SlbUCl5CHTCV84wwuRhv9MCMdL82NEqivYwxWOLS">
	<meta name="Vectorcoder" content="http://ionicecommerce.com">
	
			<link href="./Ecommerce _ Home_files/app.css" media="all" rel="stylesheet" type="text/css">
        <link href="./Ecommerce _ Home_files/jquery-ui.css" media="all" rel="stylesheet" type="text/css">
    <!---- slider --->
    <link href="./Ecommerce _ Home_files/bootstrap-slider.css" media="all" rel="stylesheet" type="text/css">
    <link href="./Ecommerce _ Home_files/bootstrap-select.css" media="all" rel="stylesheet" type="text/css">
    <link href="./Ecommerce _ Home_files/owl.carousel.css" media="all" rel="stylesheet" type="text/css">
	<link href="./Ecommerce _ Home_files/font-awesome.css" media="all" rel="stylesheet" type="text/css">
    
    <link href="./Ecommerce _ Home_files/rtl.css" media="all" rel="stylesheet" type="text/css">
    <link href="./Ecommerce _ Home_files/responsive.css" media="all" rel="stylesheet" type="text/css">
	
    
   
    <!--------- stripe js ------>
	<script src="./Ecommerce _ Home_files/saved_resource"></script>
    
    <link rel="stylesheet" type="text/css" href="./Ecommerce _ Home_files/base.css" data-rel-css="">
    <link rel="stylesheet" type="text/css" href="./Ecommerce _ Home_files/stripe.css" data-rel-css="">
    
    <!------- paypal ---------->
    <script src="./Ecommerce _ Home_files/checkout.js.download"></script><script async="true" id="xo-pptm" src="./Ecommerce _ Home_files/pptm.js.download"></script>
	
    <!---- onesignal ------>
    	<!--<link href="http://demo.laravelcommerce.com/public/onesignal/manifest.json " media="all" rel="manifest"/>-->
	<script src="./Ecommerce _ Home_files/OneSignalSDK.js.download" async=""></script>
	<script>
...
</style><script type="text/javascript" charset="UTF-8" src="./Ecommerce _ Home_files/common.js.download"></script><script type="text/javascript" charset="UTF-8" src="./Ecommerce _ Home_files/util.js.download"></script><script type="text/javascript" charset="UTF-8" src="./Ecommerce _ Home_files/stats.js.download"></script><script type="text/javascript" charset="UTF-8" src="./Ecommerce _ Home_files/AuthenticationService.Authenticate"></script></head>
...
<body dir="ltr">
                	...
                	<nav id="navbar_0" class="navbar navbar-expand-md navbar-dark navbar-0 p-0">
                        <div class="navbar-brand">
                            <select name="change_language" id="change_language" class="change-language" style="display: none;">
                                ...
                                <option value="en" data-class="en" data-style="background-image: url(http://demo.laravelcommerce.com/resources/assets/images/language_flags/1486556365.503984030_english.jpg);">English</option>
                                                           
                                <option value="ar" data-class="ar" data-style="background-image: url(http://demo.laravelcommerce.com/resources/assets/images/language_flags/1502799254.1501241757.uae.jpg);">عربى</option>
                             
                            </select><span tabindex="0" id="change_language-button" role="combobox" aria-expanded="false" aria-autocomplete="list" aria-owns="change_language-menu" aria-haspopup="true" class="ui-selectmenu-button ui-selectmenu-button-closed ui-corner-all ui-button ui-widget"><span class="ui-selectmenu-icon ui-icon ui-icon-triangle-1-s"></span><span class="ui-selectmenu-text">English</span><span id="change_language_image" class="ui-selectmenu-image" style="background-image: url(http://demo.laravelcommerce.com/resources/assets/images/language_flags/1486556365.503984030_english.jpg);">&nbsp;</span></span>
                        </div>
                ...
                <ul class="top-right-list">
                    ...
                    <span class="block">
                    	<span class="title">My Cart</span>                    
                            ...
                            <span class="items">1&nbsp;Item(s)</span>
                ...
                <div class="shopping-cart dropdown-menu dropdown-menu-right" style="pointer-events:auto !important;" aria-labelledby="dropdownMenuButton">
                    ...
                    <ul class="shopping-cart-items">
                            ...
                            <div class="item-thumb">
                            	<a href="javascript:void(0)" class="icon" onclick="delete_cart_product(860)"><img class="img-fluid" src="./Ecommerce _ Home_files/close.png" alt="icon"></a>
                            	<div class="image">
                                	<img class="img-fluid" src="./Ecommerce _ Home_files/1502174364.pPOLO2-26314826_standard_v400.jpg" alt="CLASSIC FIT COTTON POLO SHIRT">
                                </div>
                            </div>
                            <h2 class="item-name">CLASSIC FIT COTTON POLO SHIRT</h2>
                    ...
                    <div class="tt-summary">
                    	<p>Item(s)<span>1</span></p>
                      	<p>Sub Total<span>$85</span></p>
                    </div>
                    <div class="buttons">
                        <a class="btn btn-dark" href="http://demo.laravelcommerce.com/viewcart">View Cart</a>
                        <a class="btn btn-secondary" href="http://demo.laravelcommerce.com/checkout">Checkout</a>
                    </div>
                </div>
    ...
    <div class="header-navi">
    	<div class="container">
        	<div class="row align-items-center">
                                  ...
                                  <ul>
                                    <li class="dropdown-header underline">New in Stores</li>
                                          ...
                                          <div class="carousel-inner">
                                                ...
                                                <a href="http://demo.laravelcommerce.com/product-detail/ruffled-cotton-cardigan"><img src="./Ecommerce _ Home_files/1502366686.pPOLO2-25207761_standard_v400.jpg" alt="RUFFLED COTTON CARDIGAN"></a>
                                            ...
                                            <!-- End Item -->
                                                ...
                                                <a href="http://demo.laravelcommerce.com/product-detail/flag-combed-cotton-sweater"><img src="./Ecommerce _ Home_files/1502366586.pPOLO2-25834797_standard_v400.jpg" alt="FLAG COMBED COTTON SWEATER"></a>
                                                <small>Girl's Clothing</small>
                                            ...
                                            <!-- End Item -->
                                                ...
                                                <a href="http://demo.laravelcommerce.com/product-detail/fair-isle-hooded-sweater"><img src="./Ecommerce _ Home_files/1502366462.pPOLO2-26090829_standard_v400.jpg" alt="FAIR ISLE HOODED SWEATER"></a>
                                                <small>Girl's Clothing</small>
                                            ...
                                            <!-- End Item -->
                                                ...
                                                <a href="http://demo.laravelcommerce.com/product-detail/cable-knit-cashmere-sweater"><img src="./Ecommerce _ Home_files/1502366342.pPOLO2-26090785_standard_v400.jpg" alt="CABLE-KNIT CASHMERE SWEATER"></a>
                                                <small>Girl's Clothing</small>
                                            ...
                                            <!-- End Item -->
                                                ...
                                                <a href="http://demo.laravelcommerce.com/product-detail/pleated-madras-skirt"><img src="./Ecommerce _ Home_files/1502366105.pPOLO2-26091049_alternate1_v400.jpg" alt="PLEATED MADRAS SKIRT"></a>
                                                <small>Girl's Clothing</small>
              ...
              <div class="container">
                <div class="row">
                  <div class="col-12 col-lg-3 p-0"> <nav id="categories" class="navbar navbar-expand-lg p-0 categories">
  ...
  <div class="collapse navbar-collapse" id="navbar-categories">
    ...
    <ul class="navbar-nav flex-column">
      ...
      <li class="nav-item dropdown">
        <a href="http://demo.laravelcommerce.com/shop?category=men-s-clothing" class="nav-link dropdown-toggle">
          <img class="img-fuild" src="./Ecommerce _ Home_files/1528806598.shirt.png">Men's Clothing  <i class="fa fa-angle-right " aria-hidden="true"></i>         </a>
        
                <ul class="dropdown-menu multi-level">
        	            
            <li class="dropdown-submenu">
              <a class="dropdown-item" tabindex="-1" href="http://demo.laravelcommerce.com/shop?category=men-polo-shirts">
                <img class="img-fuild" src="./Ecommerce _ Home_files/1502105603.shirt.png">
                Men Polo shirts
              </a>              
            </li>            
            ...
            <li class="dropdown-submenu">
              <a class="dropdown-item" tabindex="-1" href="http://demo.laravelcommerce.com/shop?category=men-polo-shirts-1">
                <img class="img-fuild" src="./Ecommerce _ Home_files/1502178863.shirt.png">
                Men Polo shirts
              </a>              
            </li>            
            ...
            <li class="dropdown-submenu">
              <a class="dropdown-item" tabindex="-1" href="http://demo.laravelcommerce.com/shop?category=men-jeans">
                <img class="img-fuild" src="./Ecommerce _ Home_files/1502179389.jeans.png">
                Men Jeans
              </a>              
            </li>            
            ...
            <li class="dropdown-submenu">
              <a class="dropdown-item" tabindex="-1" href="http://demo.laravelcommerce.com/shop?category=men-shoes">
                <img class="img-fuild" src="./Ecommerce _ Home_files/1502179895.sneaker.png">
                Men Shoes
              </a>              
            </li>            
            ...
            <li class="dropdown-submenu">
              <a class="dropdown-item" tabindex="-1" href="http://demo.laravelcommerce.com/shop?category=sunglasses-glasses">
                <img class="img-fuild" src="./Ecommerce _ Home_files/1502180493.reading-glasses.png">
                Sunglasses &amp; Glasses
              </a>              
            </li>            
      ...
      <li class="nav-item dropdown">
        <a href="http://demo.laravelcommerce.com/shop?category=women-s-clothing" class="nav-link dropdown-toggle">
          <img class="img-fuild" src="./Ecommerce _ Home_files/1528806661.dress.png">Women's Clothing  <i class="fa fa-angle-right " aria-hidden="true"></i>         </a>
        
                <ul class="dropdown-menu multi-level">
        	            
            <li class="dropdown-submenu">
              <a class="dropdown-item" tabindex="-1" href="http://demo.laravelcommerce.com/shop?category=women-dresses">
                <img class="img-fuild" src="./Ecommerce _ Home_files/1502194101.dress.png">
                Women Dresses
              </a>              
            </li>            
            ...
            <li class="dropdown-submenu">
              <a class="dropdown-item" tabindex="-1" href="http://demo.laravelcommerce.com/shop?category=women-shirts-tops">
                <img class="img-fuild" src="./Ecommerce _ Home_files/1502194198.shirt.png">
                Women Shirts &amp; Tops
              </a>              
            </li>            
            ...
            <li class="dropdown-submenu">
              <a class="dropdown-item" tabindex="-1" href="http://demo.laravelcommerce.com/shop?category=women-jeans">
                <img class="img-fuild" src="./Ecommerce _ Home_files/1502194291.jeans.png">
                Women Jeans
              </a>              
            </li>            
            ...
            <li class="dropdown-submenu">
              <a class="dropdown-item" tabindex="-1" href="http://demo.laravelcommerce.com/shop?category=women-hand-bags">
                <img class="img-fuild" src="./Ecommerce _ Home_files/1502194427.handbag.png">
                Women Hand Bags
              </a>              
            </li>            
      ...
      <li class="nav-item dropdown">
        <a href="http://demo.laravelcommerce.com/shop?category=boy-s-clothing" class="nav-link dropdown-toggle">
          <img class="img-fuild" src="./Ecommerce _ Home_files/1502101936.man-standing-up.png">Boy's Clothing  <i class="fa fa-angle-right " aria-hidden="true"></i>         </a>
        
                <ul class="dropdown-menu multi-level">
        	            
            <li class="dropdown-submenu">
              <a class="dropdown-item" tabindex="-1" href="http://demo.laravelcommerce.com/shop?category=boy-polo-shirts">
                <img class="img-fuild" src="./Ecommerce _ Home_files/1502283220.shirt2.png">
                Boy Polo shirts
              </a>              
            </li>            
            ...
            <li class="dropdown-submenu">
              <a class="dropdown-item" tabindex="-1" href="http://demo.laravelcommerce.com/shop?category=boy-casual-shirts">
                <img class="img-fuild" src="./Ecommerce _ Home_files/1502283252.shirt.png">
                Boy Casual Shirts
              </a>              
            </li>            
            ...
            <li class="dropdown-submenu">
              <a class="dropdown-item" tabindex="-1" href="http://demo.laravelcommerce.com/shop?category=boy-pants-jeans">
                <img class="img-fuild" src="./Ecommerce _ Home_files/1502283334.jeans.png">
                Boy Pants &amp; Jeans
              </a>              
            </li>            
            ...
            <li class="dropdown-submenu">
              <a class="dropdown-item" tabindex="-1" href="http://demo.laravelcommerce.com/shop?category=boy-shoes">
                <img class="img-fuild" src="./Ecommerce _ Home_files/1502283383.sneaker.png">
                Boy Shoes
              </a>              
            </li>            
      ...
      <li class="nav-item dropdown">
        <a href="http://demo.laravelcommerce.com/shop?category=girl-s-clothing" class="nav-link dropdown-toggle">
          <img class="img-fuild" src="./Ecommerce _ Home_files/1502103958.female-silhouette.png">Girl's Clothing  <i class="fa fa-angle-right " aria-hidden="true"></i>         </a>
        
                <ul class="dropdown-menu multi-level">
        	            
            <li class="dropdown-submenu">
              <a class="dropdown-item" tabindex="-1" href="http://demo.laravelcommerce.com/shop?category=dresses-rompers">
                <img class="img-fuild" src="./Ecommerce _ Home_files/1502283482.dress.png">
                Dresses &amp; Rompers
              </a>              
            </li>            
            ...
            <li class="dropdown-submenu">
              <a class="dropdown-item" tabindex="-1" href="http://demo.laravelcommerce.com/shop?category=shorts-skirts">
                <img class="img-fuild" src="./Ecommerce _ Home_files/1502283595.short-skirt.png">
                Shorts &amp; Skirts
              </a>              
            </li>            
            ...
            <li class="dropdown-submenu">
              <a class="dropdown-item" tabindex="-1" href="http://demo.laravelcommerce.com/shop?category=sweaters">
                <img class="img-fuild" src="./Ecommerce _ Home_files/1502283706.pullover.png">
                Sweaters
              </a>              
            </li>            
      ...
      <li class="nav-item dropdown">
        <a href="http://demo.laravelcommerce.com/shop?category=baby-mother" class="nav-link dropdown-toggle">
          <img class="img-fuild" src="./Ecommerce _ Home_files/1528806779.dress (1).png">Baby &amp; Mother  <i class="fa fa-angle-right " aria-hidden="true"></i>         </a>
        
                <ul class="dropdown-menu multi-level">
        	            
            <li class="dropdown-submenu">
              <a class="dropdown-item" tabindex="-1" href="http://demo.laravelcommerce.com/shop?category=new-born">
                <img class="img-fuild" src="./Ecommerce _ Home_files/1502263460.smiling-baby.png">
                New Born
              </a>              
            </li>            
            ...
            <li class="dropdown-submenu">
              <a class="dropdown-item" tabindex="-1" href="http://demo.laravelcommerce.com/shop?category=baby-dresses">
                <img class="img-fuild" src="./Ecommerce _ Home_files/1502267564.dress.png">
                Baby Dresses
              </a>              
            </li>            
            ...
            <li class="dropdown-submenu">
              <a class="dropdown-item" tabindex="-1" href="http://demo.laravelcommerce.com/shop?category=baby-blankets-swaddles">
                <img class="img-fuild" src="./Ecommerce _ Home_files/1502273393.blanket.png">
      ...
      <li class="nav-item dropdown">
        <a href="http://demo.laravelcommerce.com/shop?category=household-merchandises" class="nav-link dropdown-toggle">
          <img class="img-fuild" src="./Ecommerce _ Home_files/1528806720.sofa.png">Household Merchandises  <i class="fa fa-angle-right " aria-hidden="true"></i>         </a>
        
                <ul class="dropdown-menu multi-level">
        	            
            <li class="dropdown-submenu">
              <a class="dropdown-item" tabindex="-1" href="http://demo.laravelcommerce.com/shop?category=bedding-collections">
                <img class="img-fuild" src="./Ecommerce _ Home_files/1502274677.modern-double-bed.png">
                Bedding Collections
              </a>              
            </li>            
            ...
            <li class="dropdown-submenu">
              <a class="dropdown-item" tabindex="-1" href="http://demo.laravelcommerce.com/shop?category=throws-pillows">
                <img class="img-fuild" src="./Ecommerce _ Home_files/1502278859.pillow.png">
                Throws &amp; Pillows
              </a>              
            </li>            
            ...
            <li class="dropdown-submenu">
              <a class="dropdown-item" tabindex="-1" href="http://demo.laravelcommerce.com/shop?category=bath-robes">
                <img class="img-fuild" src="./Ecommerce _ Home_files/1502280642.bath-robe.png">
                Bath Robes
              </a>              
            </li>            
      ...
      <li class="nav-item dropdown">
        <a href="http://demo.laravelcommerce.com/shop?category=health-beauty-hair" class="nav-link dropdown-toggle">
          <img class="img-fuild" src="./Ecommerce _ Home_files/1528806373.heart.png">Health &amp; Beauty, Hair         </a>
        
                </li>
             
      <li class="nav-item dropdown">
        <a href="http://demo.laravelcommerce.com/shop?category=automobiles-motorcycles" class="nav-link dropdown-toggle">
          <img class="img-fuild" src="./Ecommerce _ Home_files/1528806436.car.png">Automobiles &amp; Motorcycles         </a>
        
                </li>
             
      <li class="nav-item dropdown">
        <a href="http://demo.laravelcommerce.com/shop?category=jewelry-watches" class="nav-link dropdown-toggle">
          <img class="img-fuild" src="./Ecommerce _ Home_files/1528806495.wedding-ring.png">Jewelry &amp; Watches         </a>
        
                </li>
             
      <li class="nav-item dropdown">
        <a href="http://demo.laravelcommerce.com/shop?category=cellphones-accessories" class="nav-link dropdown-toggle">
          <img class="img-fuild" src="./Ecommerce _ Home_files/1528806529.mobile-phone.png">Cellphones &amp; Accessories         </a>
        
                </li>
             
      <li class="nav-item dropdown">
        <a href="http://demo.laravelcommerce.com/shop?category=computer-office-security" class="nav-link dropdown-toggle">
          <img class="img-fuild" src="./Ecommerce _ Home_files/1528806833.computer.png">Computer, Office, Security         </a>
                  ...
                  <div class="col-12 col-lg-9 p-0"> <div id="myCarousel" class="carousel slide" data-ride="carousel">
	...
	<div class="carousel-inner">
					<div class="carousel-item">
							<img width="100%" class="first-slide" src="./Ecommerce _ Home_files/1531931372.banner-001.jpg" alt="First slide">
				
			</div>
					
					<div class="carousel-item">
							<a href="http://demo.laravelcommerce.com/product-detail/ruffled-cotton-cardigan">
							<img width="100%" class="first-slide" src="./Ecommerce _ Home_files/1531842089.SLID3-(1).jpg" alt="First slide">
				</a>
			</div>
					
					<div class="carousel-item active">
							<img width="100%" class="first-slide" src="./Ecommerce _ Home_files/1531842038.SLID5-3.jpg" alt="First slide">
				
			</div>
					
					<div class="carousel-item  ">
							<a href="http://demo.laravelcommerce.com/product-detail/ruffled-cotton-cardigan">
							<img width="100%" class="first-slide" src="./Ecommerce _ Home_files/1531842053.BANNAR_4_5.jpg" alt="First slide">
				</a>
			</div>
  ...
  <div class="container"> 
    	...
    	<div class="row">
        	<div class="col-12 col-sm-4">
            	<div class="banner-image">
                	<a title="Banner Image" href="http://demo.laravelcommerce.com/shop"><img class="img-fluid" src="./Ecommerce _ Home_files/banner_1_en.jpg" alt="Banner Image"></a>
                </div>
            </div>
            <div class="col-12 col-sm-4">
            	<div class="banner-image">
                	<a title="Banner Image" href="http://demo.laravelcommerce.com/shop"><img class="img-fluid" src="./Ecommerce _ Home_files/banner_2_en.jpg" alt="Banner Image"></a>
                </div>
            </div>
            <div class="col-12 col-sm-4">
            	<div class="banner-image">
                	<a title="Banner Image" href="http://demo.laravelcommerce.com/shop"><img class="img-fluid" src="./Ecommerce _ Home_files/banner_3_en.jpg" alt="Banner Image"></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="group-banners ar">
    	<div class="row">
        	<div class="col-12 col-sm-4">
            	<div class="banner-image">
                	<a title="Banner Image" href="http://demo.laravelcommerce.com/shop"><img class="img-fluid" src="./Ecommerce _ Home_files/banner_1_ar.jpg" alt="Banner Image"></a>
                </div>
            </div>
            <div class="col-12 col-sm-4">
            	<div class="banner-image">
                	<a title="Banner Image" href="http://demo.laravelcommerce.com/shop"><img class="img-fluid" src="./Ecommerce _ Home_files/banner_2_ar.jpg" alt="Banner Image"></a>
                </div>
            </div>
            <div class="col-12 col-sm-4">
            	<div class="banner-image">
                	<a title="Banner Image" href="http://demo.laravelcommerce.com/shop"><img class="img-fluid" src="./Ecommerce _ Home_files/banner_3_ar.jpg" alt="Banner Image"></a>
                </div>
            </div>
        </div>
    </div>
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="tab-content">
          	<div class="overlay" style="display:none;"><img src="./Ecommerce _ Home_files/loader.gif"></div>
            <div role="tabpanel" class="tab-pane fade show active" id="featured" aria-labelledby="featured-tab">
              <div id="owl_featured" class="owl-carousel owl_featured owl-loaded owl-drag"> 
                ...
                <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(0px, 0px, 0px); transition: 0s; width: 3120px;"><div class="owl-item active" style="width: 230px; margin-right: 10px;"><div class="product">
                  <article>
                  	
                       <div class="thumb"> <img class="img-fluid" src="./Ecommerce _ Home_files/1502174889.pPOLO2-26314766_standard_v400.jpg" alt="CLASSIC FIT SOFT-TOUCH POLO"></div>
                ...
                </div></div><div class="owl-item active" style="width: 230px; margin-right: 10px;"><div class="product">
                  <article>
                  	
                       <div class="thumb"> <img class="img-fluid" src="./Ecommerce _ Home_files/1502181584.pPOLO2-26008953_standard_v400.jpg" alt="STANDARD FIT COTTON POPOVER"></div>
						                        <span class="tag text-center">
                        	Men's Clothing                        </span>
                     ...
                     <div class="product-hover">
                     	<div class="icons">
                        	<div class="icon-liked">
                            	...
                            	<span products_id="8" class="fa  fa-heart-o  is_liked"><span class="badge badge-secondary">4</span></span>
                            </div>
                  ...
                  <article>
                       ...
                       <div class="thumb"> <img class="img-fluid" src="./Ecommerce _ Home_files/1502190187.pPOLO2-26315541_standard_v400.jpg" alt="HAMPTON STRAIGHT FIT JEAN"></div>
						                        <span class="tag text-center">
                        	Men's Clothing                        </span>
                  ...
                  <article>
                       ...
                       <div class="thumb"> <img class="img-fluid" src="./Ecommerce _ Home_files/1502174364.pPOLO2-26314826_standard_v400.jpg" alt="CLASSIC FIT COTTON POLO SHIRT"></div>
						                        <span class="tag text-center">
                        	Men's Clothing                        </span>
                     ...
                     <div class="product-hover">
                        ...
                        <div class="buttons">
                        	                                <button class="btn btn-block btn-secondary active">Added!</button>
                                                    </div>
                     </div>
                  ...
                  <article>
                       ...
                       <div class="thumb"> <img class="img-fluid" src="./Ecommerce _ Home_files/1502366105.pPOLO2-26091049_alternate1_v400.jpg" alt="PLEATED MADRAS SKIRT"></div>
						                        <span class="tag text-center">
                ...
                </div></div><div class="owl-item" style="width: 230px; margin-right: 10px;"><div class="product">
                  <article>
                  	
                       <div class="thumb"> <img class="img-fluid" src="./Ecommerce _ Home_files/1502366686.pPOLO2-25207761_standard_v400.jpg" alt="RUFFLED COTTON CARDIGAN"></div>
						                        <span class="tag text-center">
                        	Girl's Clothing                        </span>
                  ...
                  <article>
                       ...
                       <div class="thumb"> <img class="img-fluid" src="./Ecommerce _ Home_files/1502114036.pPOLO2-26316336_standard_v400.jpg" alt="HAMPTON CLASSIC FIT SHIRT"></div>
						                        <span class="tag text-center">
                        	Men's Clothing                        </span>
                  ...
                  <article>
                       ...
                       <div class="thumb"> <img class="img-fluid" src="./Ecommerce _ Home_files/1502176579.pPOLO2-26316348_standard_v400.jpg" alt="CUSTOM SLIM FIT COTTON SHIRT"></div>
						                        <span class="tag text-center">
                        	Men's Clothing                        </span>
                  ...
                  <article>
                       ...
                       <div class="thumb"> <img class="img-fluid" src="./Ecommerce _ Home_files/1502177321.pPOLO2-26314634_standard_v400.jpg" alt="CUSTOM SLIM FIT WEATHERED POLO"></div>
						                        <span class="tag text-center">
                        	Men's Clothing                        </span>
                  ...
                  <article>
                       ...
                       <div class="thumb"> <img class="img-fluid" src="./Ecommerce _ Home_files/1502180946.pPOLO2-26008917_standard_v400.jpg" alt="STANDARD FIT COTTON SHIRT"></div>
						                        <span class="tag text-center">
                        	Men's Clothing                        </span>
                  ...
                  <article>
                       ...
                       <div class="thumb"> <img class="img-fluid" src="./Ecommerce _ Home_files/1502182426.pPOLO2-26008935_standard_v400.jpg" alt="STANDARD FIT MADRAS POPOVER"></div>
						                        <span class="tag text-center">
                        	Men's Clothing                        </span>
                  ...
                  <article>
                       ...
                       <div class="thumb"> <img class="img-fluid" src="./Ecommerce _ Home_files/1502186978.pPOLO2-26315018_standard_v400.jpg" alt="STANDARD FIT COTTON WORKSHIRT"></div>
						                        <span class="tag text-center">
                        	Men's Clothing                        </span>
                ...
                </div></div><div class="owl-item" style="width: 230px; margin-right: 10px;"><div class="product last-product">
                      <article>
            ...
            <div role="tabpanel" class="tab-pane fade" id="special" aria-labelledby="special-tab">
              <div id="owl_special" class="owl-carousel owl-loaded owl-drag">                                 
                                ...
                                <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(0px, 0px, 0px); transition: 0s;"><div class="owl-item"><div class="product">
                  <article>
                  
                  	<div class="thumb"><img class="img-fluid" src="./Ecommerce _ Home_files/1502366586.pPOLO2-25834797_standard_v400.jpg" alt="FLAG COMBED COTTON SWEATER"></div>
                  ...
                  <article>
                  	...
                  	<div class="thumb"><img class="img-fluid" src="./Ecommerce _ Home_files/1502364697.pPOLO2-23643008_standard_v400.jpg" alt="COTTON CHINO BELTED SHIRTDRESS"></div>
                  ...
                  <article>
                  	...
                  	<div class="thumb"><img class="img-fluid" src="./Ecommerce _ Home_files/1502363119.pPOLO2-25464682_standard_v400.jpg" alt="PROPELL II SNEAKER"></div>
                  ...
                  <article>
                  	...
                  	<div class="thumb"><img class="img-fluid" src="./Ecommerce _ Home_files/1502362089.pPOLO2-14689748_standard_v400.jpg" alt="POLO I WOOL TWILL SUIT"></div>
                  ...
                  <article>
                  	...
                  	<div class="thumb"><img class="img-fluid" src="./Ecommerce _ Home_files/1502353123.pPOLO2-10531663_standard_v400.jpg" alt="SLIM MOTT-WASH JEAN"></div>
                  ...
                  <article>
                  	...
                  	<div class="thumb"><img class="img-fluid" src="./Ecommerce _ Home_files/1502351882.pPOLO2-24921004_standard_v400.jpg" alt="COTTON MESH WORKSHIRT"></div>
                  ...
                  <article>
                  	...
                  	<div class="thumb"><img class="img-fluid" src="./Ecommerce _ Home_files/1502274870.pPOLO2-25426585_alternate7_v360x480.jpg" alt="RL Bowery Sateen Duvet Cover"></div>
                  ...
                  <article>
                  	...
                  	<div class="thumb"><img class="img-fluid" src="./Ecommerce _ Home_files/1502268706.pPOLO2-25240665_standard_v400.jpg" alt="RUFFLED FLORAL DRESS &amp; BLOOMER"></div>
                    <span class="discount-tag">57%</span>                     <span class="tag text-center">
						Baby &amp; Mother                    </span>
                  ...
                  <article>
                  	...
                  	<div class="thumb"><img class="img-fluid" src="./Ecommerce _ Home_files/1502268005.pPOLO2-25655666_standard_v400.jpg" alt="STRIPED POLO DRESS &amp; BLOOMER"></div>
                  ...
                  <article>
                  	...
                  	<div class="thumb"><img class="img-fluid" src="./Ecommerce _ Home_files/1502264917.pPOLO2-21465903_lifestyle_v400.jpg" alt="STRIPED COTTON HENLEY COVERALL"></div>
                  ...
                  <article>
                  	...
                  	<div class="thumb"><img class="img-fluid" src="./Ecommerce _ Home_files/1502195102.pPOLO2-25759495_alternate1_v400.jpg" alt="MADRAS FIT-AND-FLARE DRESS"></div>
            ...
            <div role="tabpanel" class="tab-pane fade" id="liked" aria-labelledby="liked-tab">
              <div id="owl_liked" class="owl-carousel owl-loaded owl-drag"> 
                  ...
                  <article>
                  	<div class="thumb"><img class="img-fluid" src="./Ecommerce _ Home_files/1502366342.pPOLO2-26090785_standard_v400.jpg" alt="CABLE-KNIT CASHMERE SWEATER"></div>
                                        <span class="tag text-center">
                    	Girl's Clothing                    </span>
                  ...
                  <article>
                  	<div class="thumb"><img class="img-fluid" src="./Ecommerce _ Home_files/1502365515.pPOLO2-26091862_alternate1_v400.jpg" alt="FLORAL SKIRT"></div>
                                        <span class="tag text-center">
                    	Girl's Clothing                    </span>
                  ...
                  <article>
                  	<div class="thumb"><img class="img-fluid" src="./Ecommerce _ Home_files/1502191568.pPOLO2-26256404_standard_v400.jpg" alt="DILLIAN II SUEDE CHELSEA BOOT"></div>
                                        <span class="tag text-center">
                    	Men's Clothing                    </span>
                                        ...
                                        <div class="icons">
                                       	...
                                       	<div class="buttons">
                                                ...
                                                <button class="btn btn-block btn-secondary cart" products_id="1">Add to Cart</button>                                               
                                                    ...
                                                    <div class="product">
                              <article>
                                <div class="thumb"> <img class="img-fluid" src="./Ecommerce _ Home_files/1502349501.pPOLO2-25563187_standard_v400.jpg" alt="COTTON MESH LONG-SLEEVE POLO"> </div>
                                                                        <span class="tag text-center">
                                        Boy's Clothing                                    </span>
                                    
                                    <h2 class="title text-center">COTTON MESH LONG-SLEEVE POLO</h2>                                
                                    <div class="price text-center">                                         
                                        $45                                        
                                                                            </div>
                                    ...
                                    <div class="product-hover">
                                        <div class="icons">
                                            <div class="icon-liked">
                                                <span products_id="59" class="fa  fa-heart-o  is_liked"><span class="badge badge-secondary">2</span></span>
                                            </div>
                                            
                                            <a href="http://demo.laravelcommerce.com/product-detail/cotton-mesh-long-sleeve-polo" class="fa fa-eye"></a>
                                        </div>
                                        
                                       	<div class="buttons">
                                        	                                         
                                                <button class="btn btn-block btn-secondary cart" products_id="59">Add to Cart</button>                                               
                                                                                    </div>
                                        ...
                                        <div class="icons">
                                       	...
                                       	<div class="buttons">
                                                ...
                                                <button class="btn btn-block btn-secondary cart" products_id="13">Add to Cart</button>                                               
                                                    ...
                                                    <div class="product">
                              <article>
                                <div class="thumb"> <img class="img-fluid" src="./Ecommerce _ Home_files/1502365189.pPOLO2-26091856_standard_v400.jpg" alt="BUTTON-FRONT DENIM SKIRT"> </div>
                                                                        <span class="tag text-center">
                                        Girl's Clothing                                    </span>
                                        ...
                                        <div class="icons">
                                       	...
                                       	<div class="buttons">
                                                ...
                                                <button class="btn btn-block btn-secondary cart" products_id="80">Add to Cart</button>                                               
                                                    ...
                                                    <div class="product">
                              <article>
                                <div class="thumb"> <img class="img-fluid" src="./Ecommerce _ Home_files/1502366462.pPOLO2-26090829_standard_v400.jpg" alt="FAIR ISLE HOODED SWEATER"> </div>
                                                                        <span class="tag text-center">
                                        Girl's Clothing                                    </span>
    	...
    	<div class="row">
        	<div class="col-xs-12 col-md-12">
            	<div class="banner-image en">
                    <a title="Banner Image" href="http://demo.laravelcommerce.com/#"><img class="img-fluid" src="./Ecommerce _ Home_files/sale_banners_en.jpg" alt="Banner Image"></a>
                </div>
                <div class="banner-image ar">
                    <a title="Banner Image" href="http://demo.laravelcommerce.com/#"><img class="img-fluid" src="./Ecommerce _ Home_files/sale_banners_ar.jpg" alt="Banner Image"></a>
                </div>
            </div>
        </div>
    </div>
  ...
  <div class="container">
    ...
    <div class="group-banners">
    	<div class="row">
        	<div class="col-xs-12 col-sm-12">
            	<div class="banner-image en">
                    <a title="Banner Image" href="http://demo.laravelcommerce.com/#"><img class="img-fluid" src="./Ecommerce _ Home_files/large_banner_en.jpg" alt="Banner Image"></a>
                </div>
                <div class="banner-image ar">
                    <a title="Banner Image" href="http://demo.laravelcommerce.com/#"><img class="img-fluid" src="./Ecommerce _ Home_files/large_banner_ar.jpg" alt="Banner Image"></a>
                </div>
            </div>
        </div>
    </div>
                                        ...
                                        <article>
                                            <div class="module">
                                            	<a href="http://demo.laravelcommerce.com/shop?category=men-s-clothing" class="cat-thumb">
                                                   <img class="img-fluid" src="./Ecommerce _ Home_files/1502285429.men.jpg" alt="Men&#39;s Clothing">             
                                                </a>
                                        ...
                                        <article>
                                            <div class="module">
                                            	<a href="http://demo.laravelcommerce.com/shop?category=women-s-clothing" class="cat-thumb">
                                                   <img class="img-fluid" src="./Ecommerce _ Home_files/1502285278.women.jpg" alt="Women&#39;s Clothing">             
                                                </a>
                                        ...
                                        <article>
                                            <div class="module">
                                            	<a href="http://demo.laravelcommerce.com/shop?category=boy-s-clothing" class="cat-thumb">
                                                   <img class="img-fluid" src="./Ecommerce _ Home_files/1502285654.boys.jpg" alt="Boy&#39;s Clothing">             
                                                </a>
                                        ...
                                        <article>
                                            <div class="module">
                                            	<a href="http://demo.laravelcommerce.com/shop?category=girl-s-clothing" class="cat-thumb">
                                                   <img class="img-fluid" src="./Ecommerce _ Home_files/1502285903.girls.jpg" alt="Girl&#39;s Clothing">             
                                                </a>
                                        ...
                                        <article>
                                            <div class="module">
                                            	<a href="http://demo.laravelcommerce.com/shop?category=baby-mother" class="cat-thumb">
                                                   <img class="img-fluid" src="./Ecommerce _ Home_files/1502285986.babies.jpg" alt="Baby &amp; Mother">             
                                                </a>
                                        ...
                                        <article>
                                            <div class="module">
                                            	<a href="http://demo.laravelcommerce.com/shop?category=household-merchandises" class="cat-thumb">
                                                   <img class="img-fluid" src="./Ecommerce _ Home_files/1502286030.home.jpg" alt="Household Merchandises">             
                                                </a>
                                        ...
                                        <article>
                                            <div class="module">
                                            	<a href="http://demo.laravelcommerce.com/shop?category=health-beauty-hair" class="cat-thumb">
                                                   <img class="img-fluid" src="./Ecommerce _ Home_files/1531492780.healthandbeauty.jpg" alt="Health &amp; Beauty, Hair">             
                                                </a>
                                        ...
                                        <article>
                                            <div class="module">
                                            	<a href="http://demo.laravelcommerce.com/shop?category=automobiles-motorcycles" class="cat-thumb">
                                                   <img class="img-fluid" src="./Ecommerce _ Home_files/1531492795.automobiles.jpg" alt="Automobiles &amp; Motorcycles">             
                                                </a>
                                        ...
                                        <article>
                                            <div class="module">
                                            	<a href="http://demo.laravelcommerce.com/shop?category=jewelry-watches" class="cat-thumb">
                                                   <img class="img-fluid" src="./Ecommerce _ Home_files/1531492822.watches.jpg" alt="Jewelry &amp; Watches">             
                                                </a>
                                        ...
                                        <article>
                                            <div class="module">
                                            	<a href="http://demo.laravelcommerce.com/shop?category=cellphones-accessories" class="cat-thumb">
                                                   <img class="img-fluid" src="./Ecommerce _ Home_files/1531492844.mobiles.jpg" alt="Cellphones &amp; Accessories">             
                                                </a>
                            ...
                            <div class="product-hover">
                                ...
                                <div class="buttons">
                                        ...
                                        <button class="btn btn-block btn-secondary cart" products_id="75">Add to Cart</button>
                                                ...
                                                <div class="product">
                          <article>
                            <div class="thumb"> <img class="img-fluid" src="./Ecommerce _ Home_files/1502364932.pPOLO2-25835439_standard_v400.jpg" alt="STRIPED OFF-THE-SHOULDER DRESS"> </div>
                                                        <span class="tag text-center">
                            Girl's Clothing                            </span>
                            ...
                            <div class="product-hover">
                                ...
                                <div class="buttons">
                                        ...
                                        <button class="btn btn-block btn-secondary cart" products_id="73">Add to Cart</button>
                                                ...
                                                <div class="product">
                          <article>
                            <div class="thumb"> <img class="img-fluid" src="./Ecommerce _ Home_files/1502364150.pPOLO2-26091141_standard_v400.jpg" alt="MADRAS COTTON SHIRTDRESS"> </div>
                                                        <span class="tag text-center">
                            Girl's Clothing                            </span>
            	...
            	<!-- Blog Post -->
                            ...
                            <article>
                                <div class="blog-thumb">
                                    ...
                                    <img class="img-fluid" src="./Ecommerce _ Home_files/1531930664.blog-img-2.jpg" alt="">
                                </div>
                            </article>
                        </div>
                	                        <div class="blog-post">
                            <article>
                                <div class="blog-thumb">
                                    ...
                                    <img class="img-fluid" src="./Ecommerce _ Home_files/1531930697.blog-img-3.jpg" alt="">
                                </div>
                            </article>
                        </div>
                	                        <div class="blog-post">
                            <article>
                                <div class="blog-thumb">
                                    ...
                                    <img class="img-fluid" src="./Ecommerce _ Home_files/1531930680.blog-img-1.jpg" alt="">
                                </div>
                            </article>
                        </div>
                	            				</div>
      ...
      <div class="col-12 col-lg-4">
        <div class="single-footer">
            ...
            <div class="socials">
            	<h5>Follow Us</h5>
                <ul class="list">
                	<li><a href="http://demo.laravelcommerce.com/#" class="fa fa-facebook"></a></li>
                    <li><a href="http://demo.laravelcommerce.com/#" class="fa fa-twitter"></a></li>
                    <li><a href="http://demo.laravelcommerce.com/#" class="fa fa-skype"></a></li>
                    <li><a href="http://demo.laravelcommerce.com/#" class="fa fa-linkedin"></a></li>
                </ul>
            </div>
  ...
  <div class="container">
    <div class="row">
    	<div class="footer-image col-12 col-md-6">
            <img class="img-fluid" src="./Ecommerce _ Home_files/payments.png">
        </div>
        ...
        <div class="floating-top"><a href="http://demo.laravelcommerce.com/#" class="fa fa-angle-up"></a></div>
    </div>
  </div>
</div>
...
<div class="loader" id="loader" style="display: none;">
	<img src="./Ecommerce _ Home_files/loader.gif">
</div>
	<!-- all js scripts including custom js -->

	<!-- scripts -->
<script src="./Ecommerce _ Home_files/app.js.download"></script>
<script src="./Ecommerce _ Home_files/jquery-ui.js.download"></script>

<!-- owl carousel -->
<script src="./Ecommerce _ Home_files/owl.carousel.js.download"></script>

<!--- google map-->
<script type="text/javascript" src="./Ecommerce _ Home_files/js"></script>
