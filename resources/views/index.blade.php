...
<head>
    ...
    <script type="text/javascript" charset="UTF-8" src="{{ asset('js/common.js.download') }}"></script><script type="text/javascript" charset="UTF-8" src="{{ asset('js/util.js.download') }}"></script><script type="text/javascript" charset="UTF-8" src="{{ asset('js/stats.js.download') }}"></script></head>
<!-- ./end of meta -->
	...
	<!-- <div class="header-mini">
    	<div class="container">
            <div class="row align-items-center">
                <div class="col-12"><nav id="navbar_0" class="navbar navbar-expand-md navbar-dark navbar-0 p-0">
                	...
                	<nav id="navbar_0" class="navbar navbar-expand-md navbar-dark navbar-0 p-0">
                        <div class="navbar-brand">
                            <select name="change_language" id="change_language" class="change-language">                       
                                ...
                                <option value="ar" data-class="ar" data-style="background-image: url(http://demo.laravelcommerce.com/resources/assets/images/language_flags/1502799254.1501241757.uae.jpg);" >ភាសាខ្មែរ<span class="flag-icon flag-icon-kh"></span></option>
                            </select>                            
                        </div>
                        <button type="button" class="navbar-toggler" data-toggle="collapse" data-target="#navbar_collapse_0" aria-controls="navbar_collapse_0" aria-expanded="false" aria-label="Toggle navigation">
                            <span class="navbar-toggler-icon"></span>
          ...
          <div class="tab-content">
            ...
            <div role="tabpanel" class="tab-pane fade show active" id="featured" aria-labelledby="featured-tab">
              <div id="owl_featured" class="owl-carousel owl_featured owl-loaded owl-drag"> 
                ...
                <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s; width: 3120px;"><div class="owl-item active" style="width: 230px; margin-right: 10px;"><div class="product">
                  <article>
