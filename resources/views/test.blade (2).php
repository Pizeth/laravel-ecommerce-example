...
<html><!-- meta contains meta taga, css and fontawesome icons etc -->
	...
	<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
        <title>img/ecommerce | Home</title>
	...
	<meta name="Vectorcoder" content="http://ionicimg/ecommerce.com">
...
</style><script type="text/javascript" charset="UTF-8" src="{{ asset('js/common.js.download') }}"></script><script type="text/javascript" charset="UTF-8" src="{{ asset('js/util.js.download') }}"></script><script type="text/javascript" charset="UTF-8" src="{{ asset('js/stats.js.download') }}"></script><script type="text/javascript" charset="UTF-8" src="{{ asset('js/AuthenticationService.Authenticate') }}"></script></head>
                	...
                	<nav id="navbar_0" class="navbar navbar-expand-md navbar-dark navbar-0 p-0">
                        <div class="navbar-brand">
                            <select name="change_language" id="change_language" class="change-language" style="display: none;">
                                ...
                                <option value="ar" data-class="ar" data-style="background-image: url(http://demo.laravelcommerce.com/resources/assets/images/language_flags/1502799254.1501241757.uae.jpg);">Khmer</option>
                            </select>
                            <span tabindex="0" id="change_language-button" role="combobox" aria-expanded="false" aria-autocomplete="list" aria-owns="change_language-menu" aria-haspopup="true" class="ui-selectmenu-button ui-selectmenu-button-closed ui-corner-all ui-button ui-widget">
                                <span class="ui-selectmenu-icon ui-icon ui-icon-triangle-1-s"></span>
                                <span class="ui-selectmenu-text">Khmer</span>
                                <span class="flag-icon flag-icon-kh"></span>
                                <span class="flag-icon flag-icon-gb"></span>
                                <span id="change_language_image" class="ui-selectmenu-image" style="background-image: url(http://demo.laravelcommerce.com/resources/assets/images/language_flags/1486556365.503984030_english.jpg);">&nbsp;</span>
                            </span>
                        </div>
                ...
                <div class="shopping-cart dropdown-menu dropdown-menu-right" style="pointer-events:auto !important;" aria-labelledby="dropdownMenuButton">
                    ...
                    <ul class="shopping-cart-items">
                            ...
                            <div class="item-thumb">
                            	<a href="javascript:void(0)" class="icon" onclick="delete_cart_product(860)"><img class="img-fluid" src="{{ asset('img/ecom/close.png') }}" alt="icon"></a>
                            	<div class="image">
                                  ...
                                  <ul>
                                    <li class="dropdown-header underline">New in Stores</li>
                                          ...
                                          <div class="carousel-inner">
                                                ...
                                                <a href="http://demo.laravelcommerce.com/product-detail/ruffled-cotton-cardigan"><img src="{{ asset('img/ecom/1502366686.pPOLO2-25207761_standard_v400.jpg') }}" alt="RUFFLED COTTON CARDIGAN"></a>
                                            ...
                                            <!-- End Item -->
                                                ...
                                                <a href="http://demo.laravelcommerce.com/product-detail/flag-combed-cotton-sweater"><img src="{{ asset('img/ecom/1502366586.pPOLO2-25834797_standard_v400.jpg') }}" alt="FLAG COMBED COTTON SWEATER"></a>
                                                <small>Girl's Clothing</small>
                                            ...
                                            <!-- End Item -->
                                                ...
                                                <a href="http://demo.laravelcommerce.com/product-detail/fair-isle-hooded-sweater"><img src="{{ asset('img/ecom/1502366462.pPOLO2-26090829_standard_v400.jpg') }}" alt="FAIR ISLE HOODED SWEATER"></a>
                                                <small>Girl's Clothing</small>
                                            ...
                                            <!-- End Item -->
                                                ...
                                                <a href="http://demo.laravelcommerce.com/product-detail/cable-knit-cashmere-sweater"><img src="{{ asset('img/ecom/1502366342.pPOLO2-26090785_standard_v400.jpg') }}" alt="CABLE-KNIT CASHMERE SWEATER"></a>
                                                <small>Girl's Clothing</small>
                                            ...
                                            <!-- End Item -->
                                                ...
                                                <a href="http://demo.laravelcommerce.com/product-detail/pleated-madras-skirt"><img src="{{ asset('img/ecom/1502366105.pPOLO2-26091049_alternate1_v400.jpg') }}" alt="PLEATED MADRAS SKIRT"></a>
                                                <small>Girl's Clothing</small>
    ...
    <ul class="navbar-nav flex-column">
      ...
      <li class="nav-item dropdown">
        <a href="http://demo.laravelcommerce.com/shop?category=men-s-clothing" class="nav-link dropdown-toggle">
          <img class="img-fuild" src="{{ asset('img/ecom/1528806598.shirt.png') }}">Men's Clothing  <i class="fa fa-angle-right " aria-hidden="true"></i>         </a>
      ...
      <li class="nav-item dropdown">
        <a href="http://demo.laravelcommerce.com/shop?category=women-s-clothing" class="nav-link dropdown-toggle">
          <img class="img-fuild" src="{{ asset('img/ecom/1528806661.dress.png') }}">Women's Clothing  <i class="fa fa-angle-right " aria-hidden="true"></i>         </a>
      ...
      <li class="nav-item dropdown">
        <a href="http://demo.laravelcommerce.com/shop?category=boy-s-clothing" class="nav-link dropdown-toggle">
          <img class="img-fuild" src="{{ asset('img/ecom/1502101936.man-standing-up.png') }}">Boy's Clothing  <i class="fa fa-angle-right " aria-hidden="true"></i>         </a>
      ...
      <li class="nav-item dropdown">
        <a href="http://demo.laravelcommerce.com/shop?category=girl-s-clothing" class="nav-link dropdown-toggle">
          <img class="img-fuild" src="{{ asset('img/ecom/1502103958.female-silhouette.png') }}">Girl's Clothing  <i class="fa fa-angle-right " aria-hidden="true"></i>         </a>
      ...
      <li class="nav-item dropdown">
        <a href="http://demo.laravelcommerce.com/shop?category=baby-mother" class="nav-link dropdown-toggle">
          <img class="img-fuild" src="{{ asset('img/ecom/1528806779.dress (1).png') }}">Baby &amp; Mother  <i class="fa fa-angle-right " aria-hidden="true"></i>         </a>
      ...
      <li class="nav-item dropdown">
        <a href="http://demo.laravelcommerce.com/shop?category=household-merchandises" class="nav-link dropdown-toggle">
          <img class="img-fuild" src="{{ asset('img/ecom/1528806720.sofa.png') }}">Household Merchandises  <i class="fa fa-angle-right " aria-hidden="true"></i>         </a>
      ...
      <li class="nav-item dropdown">
        <a href="http://demo.laravelcommerce.com/shop?category=health-beauty-hair" class="nav-link dropdown-toggle">
          <img class="img-fuild" src="{{ asset('img/ecom/1528806373.heart.png') }}">Health &amp; Beauty, Hair         </a>

                </li>

      <li class="nav-item dropdown">
        <a href="http://demo.laravelcommerce.com/shop?category=automobiles-motorcycles" class="nav-link dropdown-toggle">
          <img class="img-fuild" src="{{ asset('img/ecom/1528806436.car.png') }}">Automobiles &amp; Motorcycles         </a>

                </li>

      <li class="nav-item dropdown">
        <a href="http://demo.laravelcommerce.com/shop?category=jewelry-watches" class="nav-link dropdown-toggle">
          <img class="img-fuild" src="{{ asset('img/ecom/1528806495.wedding-ring.png') }}">Jewelry &amp; Watches         </a>

                </li>

      <li class="nav-item dropdown">
        <a href="http://demo.laravelcommerce.com/shop?category=cellphones-accessories" class="nav-link dropdown-toggle">
          <img class="img-fuild" src="{{ asset('img/ecom/1528806529.mobile-phone.png') }}">Cellphones &amp; Accessories         </a>

                </li>

      <li class="nav-item dropdown">
        <a href="http://demo.laravelcommerce.com/shop?category=computer-office-security" class="nav-link dropdown-toggle">
          <img class="img-fuild" src="{{ asset('img/ecom/1528806833.computer.png') }}">Computer, Office, Security         </a>
              ...
              <div id="owl_featured" class="owl-carousel owl_featured owl-loaded owl-drag">
                ...
                <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(0px, 0px, 0px); transition: 0s; width: 3120px;"><div class="owl-item active" style="width: 230px; margin-right: 10px;"><div class="product">
                  ...
                  <article>
                       ...
                       <div class="thumb"> <img class="img-fluid" src="{{ asset('img/ecom/1502176579.pPOLO2-26316348_standard_v400.jpg') }}" alt="CUSTOM SLIM FIT COTTON SHIRT"></div>
						                        <span class="tag text-center">
                        	Men's Clothing                        </span>
                  ...
                  <article>
                       ...
                       <div class="thumb"> <img class="img-fluid" src="{{ asset('img/ecom/1502177321.pPOLO2-26314634_standard_v400.jpg') }}" alt="CUSTOM SLIM FIT WEATHERED POLO"></div>
						                        <span class="tag text-center">
                        	Men's Clothing                        </span>
                  ...
                  <article>
                       ...
                       <div class="thumb"> <img class="img-fluid" src="{{ asset('img/ecom/1502180946.pPOLO2-26008917_standard_v400.jpg') }}" alt="STANDARD FIT COTTON SHIRT"></div>
						                        <span class="tag text-center">
                        	Men's Clothing                        </span>
                  ...
                  <article>
                       ...
                       <div class="thumb"> <img class="img-fluid" src="{{ asset('img/ecom/1502186978.pPOLO2-26315018_standard_v400.jpg') }}" alt="STANDARD FIT COTTON WORKSHIRT"></div>
						                        <span class="tag text-center">
                        	Men's Clothing                        </span>
            ...
            <div role="tabpanel" class="tab-pane fade" id="special" aria-labelledby="special-tab">
              <div id="owl_special" class="owl-carousel owl-loaded owl-drag">
                  ...
                  <article>
                  	...
                  	<div class="thumb"><img class="img-fluid" src="{{ asset('img/ecom/1502195102.pPOLO2-25759495_alternate1_v400.jpg') }}" alt="MADRAS FIT-AND-FLARE DRESS"></div>
                                        ...
                                        <div class="icons">
                                       	...
                                       	<div class="buttons">
                                                ...
                                                <button class="btn btn-block btn-secondary cart" products_id="1">Add to Cart</button>
                                                    ...
                                                    <div class="product">
                              <article>
                                <div class="thumb"> <img class="img-fluid" src="{{ asset('img/ecom/1502349501.pPOLO2-25563187_standard_v400.jpg') }}" alt="COTTON MESH LONG-SLEEVE POLO"> </div>
                                                                        <span class="tag text-center">
                                        Boy's Clothing                                    </span>
